...
for (const [id] of tools) {
  ...
  if (!fs.existsSync(filePath)) {
    const page = pageTemplate(id).replace('<section class="related-tools shell">', id === 'dcf-valuation' ? `${dcfAnalysis}<section class="related-tools shell">` : '<section class="related-tools shell">');
